...
public class CalendarView extends ViewGroup {
    ...
    public Object[] getCaledarBeanPosition(CalendarBean calendarBean){
        if (calendarBean == null) {
            return new Object[3];
        }
        for (int i = 0; i < data.size(); i++) {

            if (calendarBean.equals(data.get(i))) {
                return new Object[]{getChildAt(i),i,data.get(i)};
            }
        }
        return new Object[3];
    }
    ...
    private void setItem() {
        ...
        for (int i = 0; i < data.size(); i++) {
            ...
            View chidView = adapter.getView(view, this,isDateSelect, bean);
...
//                }
            ...
            android.util.Log.d("hzs","selectPostion = " + selectPostion);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        itemHeight =( itemWidth/2)+(itemWidth/8);
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        for (int i = 0; i <getChildCount(); i++) {
         //   Log.d("smiless",getChildAt(i)+"--"+l+"---"+t+"---"+r+"--"+b);
