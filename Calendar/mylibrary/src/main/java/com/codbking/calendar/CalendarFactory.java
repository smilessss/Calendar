...
public class CalendarFactory {
    ...
    public static List<CalendarBean> getMonthOfDayList(int y, int m) {
        ...
        Log.d("cf","getMonthOfDayList begin");
        Log.d("cf","total==="+total);
        android.util.Log.d("cf","y = " + y);
        android.util.Log.d("cf","m = " + m);
        android.util.Log.d("cf","fweek = " + fweek);
        Log.d("cf","getMonthOfDayList end");
